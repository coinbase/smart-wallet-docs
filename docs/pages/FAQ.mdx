...
At launch, Smart Wallet is separate from wallet mobile and extension. Users sign on [keys.coinbase.com](https://keys.coinbase.com/)
...
## What happens if user lose their passkey? 
Every Smart Wallet supports multiple owners, and our client encourages users to add a backup recovery key, for the unlikely case they lose their passkey.
...
but elsewhere the difference is negligible. 

...
Once you have your paymaster service set up, you can now pass its URL along to Viem's `writeContracts` action.

If you set up a proxy in your app's backend as recommended above, you'll want to pass in the proxy URL you created.
...
That's it! Smart Wallet will handle the rest. If your paymaster service is able to sponsor the transaction, Smart Wallet will indicate to your user that the transaction is gas-free.
...
```bash
cd <your-app-directory> && pnpm install viem@npm:@lukasrosario/viem@2.17.4-sessionkeys.5 wagmi@npm:@lukasrosario/wagmi@2.11.1-sessionkeys.5 @tanstack/react-query@5.0.5 buffer@6.0.3
```

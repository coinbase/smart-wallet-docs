...
We recognize that this puts a new burden on smart contract developers, but believe it is in the best interest of users to force intentional adoption of Session Keys from the contract layer to prevent attacks like phishing.

...
<div style={{ width: 200 }}>
  <div style={{ paddingBottom: 10 }}>
    ![Create Wallet Button](/createWalletButtonRainbow.png)
  </div>
...
```tsx twoslash [RainbowCreateWalletButton.tsx] filename="RainbowCreateWalletButton.tsx"
...
export function RainbowCreateWalletButton({ height = 66, width = 200 }) {

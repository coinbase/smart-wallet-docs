...
## Demo
To see a demo of the integration, you can check out the [MobileWalletProtocol/smart-wallet-expo-example](https://github.com/MobileWalletProtocol/smart-wallet-expo-example).

...
We use an environment variable for our spender's private key for simplicity of demonstration.
:::
...
This is an example of a spender that is a Coinbase Smart Wallet sponsored by a paymaster. 
EOAs or other smart contracts can also be spenders.

<Callout type="info">
  **Tips**: You can set up a paymaster and get an API key [Coinbase Developer Platform](https://portal.cdp.coinbase.com/).  

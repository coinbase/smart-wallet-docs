...
:::warning
The `useWriteContracts` and `useCapabilities` hooks used below rely on new wallet RPC and not yet supported in most wallets. 
...
:::info
[Coinbase Developer Platform](https://www.coinbase.com/developer-platform) is currently offering 0.25 ETH in paymaster gas credits
on Base. 
:::

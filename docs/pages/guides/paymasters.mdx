...
:::info
[Coinbase Developer Platform](https://www.coinbase.com/developer-platform) is currently offering the following Base gas credit promotions in their Paymaster product
- $100 upon signup (phone and email only; takes less than 2min)
- $500 for adding a credit card
- $3,000 - $15,000 for supporting the Coinbase Smart Wallet. [Apply today](https://docs.google.com/forms/d/1yPnBFW0bVUNLUN_w3ctCqYM9sjdIQO3Typ53KXlsS5g/viewform).
:::
